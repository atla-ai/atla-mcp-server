...
You can also deploy your own instance of the MCP server using the button below (you will have to set your ATLA_API_KEY as an environment variable for this to work):
