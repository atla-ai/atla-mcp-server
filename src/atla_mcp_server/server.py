...
# TODO: Overall resource for using evaluations
# TODO: How do metrics fit into the evaluate_response method?
# TODO (optional): multi-criteria evaluation as a separate method (doesn't require repeating like batch_ does)
